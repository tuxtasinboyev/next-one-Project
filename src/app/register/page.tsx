...
export default function Register() {
    ...
    // Viloyatlarni olish
    useEffect(() => {
        axios.get<Region[]>("/api/regions").then((res) => setRegions(res.data));
    }, []);
    ...
    useEffect(() => {
        ...
        axios
            .get<District[]>(`/api/districts?regionId=${selectedRegion}`)
    ...
    useEffect(() => {
        ...
        axios
            .get<Village[]>(`/api/villages?districtId=${selectedDistrict}`)
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-400 via-blue-500 to-purple-600 p-6">
            <div className="bg-white rounded-3xl shadow-2xl p-8 w-full max-w-md space-y-4">
                ...
                <select
                    ...
                    onChange={(e) =>
                        setSelectedVillage(e.target.value === "" ? "" : Number(e.target.value))
                    }
